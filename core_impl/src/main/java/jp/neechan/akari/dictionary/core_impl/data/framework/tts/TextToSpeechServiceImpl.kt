package jp.neechan.akari.dictionary.core_impl.data.framework.tts
...
import jp.neechan.akari.dictionary.core_impl.R
    ...
    override suspend fun speak(text: String) {
        doWhenTtsStateIsAtLeast(TextToSpeechState.VOICE_CONFIGURED) {
            ...
            if (result == TextToSpeech.ERROR) {
                Toast.makeText(context, R.string.tts_cant_play, Toast.LENGTH_SHORT).show()
            }
        }
    }
